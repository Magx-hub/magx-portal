...
//         <div className="text-red-600 font-medium">Error loading students</div>
...
//         <div className="text-gray-600 font-medium">No students found</div>
...
//         <div key={student.id || index} className="bg-white border border-gray-200 rounded-xl p-4 hover:shadow-md transition-shadow">
...
//               <span className="ml-2 font-medium text-gray-900">{student.studentId || 'N/A'}</span>
//             </div>
//             <div>
//               <span className="text-gray-500">Gender:</span>
//               <span className="ml-2 font-medium text-gray-900">{student.gender || 'N/A'}</span>
//             </div>
//           </div>
//         </div>
//       ))}
