import{c as X,h as B,j as t,X as Se,P as le,D as W,S as ke,C as ne,d as Ae}from"./index-BavoennM.js";import{r as u}from"./router-CrL07F0D.js";import{q as $,k as $e,o as Y,y as ce,A as ie,l as G,s as K,m as Te,n as ee,t as He,v as Ce,w as L,x as Fe}from"./firebase-DJWpnxAx.js";import"./vendor-c5ypKtDW.js";/**
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Ee=[["path",{d:"M3 12a9 9 0 1 0 9-9 9.75 9.75 0 0 0-6.74 2.74L3 8",key:"1357e3"}],["path",{d:"M3 3v5h5",key:"1xhq8a"}],["path",{d:"M12 7v5l4 2",key:"1fdv2h"}]],Ge=X("history",Ee),P="allowance_records",D=$e(B,P),Oe=e=>{const{basic7JHS:a,basic8JHS:r,basic9JHS:o}=e;return(a||0)+(r||0)+(o||0)},Je=e=>{const{creche:a,nursery1:r,nursery2:o,kg1:n,kg2:l,basic1:s,basic2:c,basic3:i,basic4:h,basic5:x,basic6:f,basic7General:m,basic8General:g,basic9General:d}=e;return(a||0)+(r||0)+(o||0)+(n||0)+(l||0)+(s||0)+(c||0)+(i||0)+(h||0)+(x||0)+(f||0)+(m||0)+(g||0)+(d||0)},de=e=>{const a=[];return(!e.weekNumber||e.weekNumber<1||e.weekNumber>52)&&a.push("Week number must be between 1 and 52"),(!e.numberOfTeachers||e.numberOfTeachers<0)&&a.push("Number of teachers must be a positive number"),(!e.numberOfJHSTeachers||e.numberOfJHSTeachers<0)&&a.push("Number of JHS teachers must be a positive number"),(!e.totalSum||e.totalSum<=0)&&a.push("Total sum must be greater than 0"),a},_=e=>new Intl.NumberFormat("en-GH",{style:"currency",currency:"GHS",minimumFractionDigits:2}).format(e||0),We=e=>{const{welfare:a,office:r,kitchen:o}=e;return(a||0)+(r||0)+(o||0)},ue=async e=>{try{const a=$(D,L("weekNumber","==",e));return!(await G(a)).empty}catch(a){throw console.error("Error checking if week exists:",a),a}},Le=async()=>{try{const a=(await G(D)).docs.map(s=>({id:s.id,...s.data()}));if(a.length===0)return{totalRecords:0,avgTotalSum:0,maxTotalSum:0,minTotalSum:0,avgTeacherAllowance:0,avgJHSTeacherAllowance:0};const r=a.length,o=a.map(s=>s.totalSum||0),n=a.map(s=>s.eachTeacher||0),l=a.map(s=>s.eachJHSTeacher||0);return{totalRecords:r,avgTotalSum:o.reduce((s,c)=>s+c,0)/r,maxTotalSum:Math.max(...o),minTotalSum:Math.min(...o),avgTeacherAllowance:n.reduce((s,c)=>s+c,0)/r,avgJHSTeacherAllowance:l.reduce((s,c)=>s+c,0)/r}}catch(e){throw console.error("Error getting allowance summary:",e),e}},ze=async(e,a)=>{try{const r=$(D,L("weekNumber",">=",e),L("weekNumber","<=",a),Y("weekNumber","asc"));return(await G(r)).docs.map(n=>({id:n.id,...n.data()}))}catch(r){throw console.error("Error getting records by range:",r),r}},Me=async e=>{try{const a=de(e);if(a.length>0)throw new Error(`Validation failed: ${a.join(", ")}`);if(await ue(e.weekNumber))throw new Error(`Record for week ${e.weekNumber} already exists`);const o={...e,createdAt:K(),updatedAt:K()};return(await Te(D,o)).id}catch(a){throw console.error("Error saving calculation:",a),a}},te=async(e=null,a=null)=>{try{let r=$(D,Y("weekNumber","desc"));e&&(r=$(r,ce(e))),a&&(r=$(r,ie(a)));const o=await G(r);return{records:o.docs.map(l=>({id:l.id,...l.data()})),lastDoc:o.docs[o.docs.length-1]||null,hasMore:o.docs.length===e}}catch(r){throw console.error("Error getting calculations:",r),r}},ae=async e=>{try{const a=$(D,L("weekNumber","==",e)),r=await G(a);if(r.empty)return null;const o=r.docs[0];return{id:o.id,...o.data()}}catch(a){throw console.error("Error getting allowance record by week:",a),a}},Be=async e=>{try{const a=ee(B,P,e),r=await Fe(a);return r.exists()?{id:r.id,...r.data()}:null}catch(a){throw console.error("Error getting allowance record by ID:",a),a}},Pe=async(e,a)=>{try{const r=de(a);if(r.length>0)throw new Error(`Validation failed: ${r.join(", ")}`);const o=ee(B,P,e),n={...a,updatedAt:K()};return await He(o,n),!0}catch(r){throw console.error("Error updating allowance record:",r),r}},Ie=async e=>{try{const a=ee(B,P,e);return await Ce(a),!0}catch(a){throw console.error("Error deleting allowance record:",a),a}},he=async(e=null,a=null)=>{try{let r=$(D,L("welfare",">",0),Y("weekNumber","desc"));e&&(r=$(r,ce(e))),a&&(r=$(r,ie(a)));const o=await G(r);return{records:o.docs.map(l=>{const s=l.data();let c="N/A";if(s.createdAt&&s.createdAt.toDate)try{c=s.createdAt.toDate().toLocaleDateString()}catch(i){console.log("Error parsing date:",s.createdAt,i)}return{id:l.id,weekNumber:s.weekNumber,welfare:s.welfare,datePaid:c}}),lastDoc:o.docs[o.docs.length-1]||null,hasMore:o.docs.length===e}}catch(r){throw console.error("Error getting welfare records:",r),r}},qe=async e=>{try{const a=await ae(e);if(!a)return null;const r=Oe(a),o=Je(a),n=We(a);return{...a,totalJHSStudents:r,totalGeneralStudents:o,totalDeductions:n,formattedTotalSum:_(a.totalSum),formattedEachTeacher:_(a.eachTeacher),formattedEachJHSTeacher:_(a.eachJHSTeacher)}}catch(a){throw console.error("Error generating weekly report:",a),a}},Ue=()=>{const[e,a]=u.useState(!1),[r,o]=u.useState(null),[n,l]=u.useState([]),[s,c]=u.useState(null),[i,h]=u.useState(null),[x,f]=u.useState(!0),m=u.useCallback(async(b,y=!0)=>{y&&a(!0),o(null);try{return await b()}catch(S){return console.error("Async operation error:",S),o(S.message||"An error occurred"),null}finally{y&&a(!1)}},[]),g=u.useCallback(async(b=20,y=!1)=>{const S=y?null:i,k=await m(()=>te(b,S));k&&(l(y?k.records:J=>[...J,...k.records]),h(k.lastDoc),f(k.hasMore))},[m,i]),d=u.useCallback(async(b=20)=>{!x||e||await g(b,!1)},[g,x,e]),p=u.useCallback(async(b=20)=>{h(null),f(!0),await g(b,!0)},[g]),N=u.useCallback(async b=>{const y=await m(()=>Me(b));return y?(await p(),y):null},[m,p]),v=u.useCallback(async(b,y)=>{const S=await m(()=>Pe(b,y));return S&&l(k=>k.map(J=>J.id===b?{...J,...y}:J)),S},[m]),F=u.useCallback(async b=>{const y=await m(()=>Ie(b));return y&&l(S=>S.filter(k=>k.id!==b)),y},[m]),q=u.useCallback(async b=>await m(()=>ae(b),!1),[m]),U=u.useCallback(async b=>await m(()=>Be(b),!1),[m]),R=u.useCallback(async()=>{const b=await m(()=>Le(),!1);return b&&c(b),b},[m]),O=u.useCallback(async(b,y)=>await m(()=>he(b,y),!1),[m]),we=u.useCallback(async(b,y)=>await m(()=>ze(b,y),!1),[m]),je=u.useCallback(async b=>await m(()=>qe(b),!1),[m]),Ne=u.useCallback(async b=>await m(()=>ue(b),!1),[m]),ve=u.useCallback(()=>{o(null)},[]);return u.useEffect(()=>{(async()=>{await Promise.all([g(20,!0),R()])})()},[]),{loading:e,error:r,allowances:n,summary:s,hasMore:x,addAllowance:N,updateAllowance:v,deleteAllowance:F,getById:U,getByWeek:q,fetchAllowances:g,refreshAllowances:p,loadMoreAllowances:d,getSummary:R,fetchWelfareRecords:O,getRecordsByRange:we,generateWeeklyReport:je,checkWeekExists:Ne,clearError:ve}},_e=({summary:e,allowances:a,loading:r,showCalculator:o,setShowCalculator:n,generatePdfReport:l})=>t.jsxs("div",{className:"space-y-4",children:[t.jsxs("div",{className:"bg-white rounded-xl shadow-sm p-4",children:[t.jsx("h2",{className:"text-lg font-semibold text-gray-900 mb-4",children:"Overview"}),t.jsxs("div",{className:"grid grid-cols-2 gap-4",children:[t.jsxs("div",{className:"bg-blue-50 p-4 rounded-xl text-center border border-blue-100",children:[t.jsx("div",{className:"text-2xl font-bold text-blue-600",children:(e==null?void 0:e.totalRecords)||0}),t.jsx("div",{className:"text-sm text-blue-600 font-medium",children:"Total Records"})]}),t.jsxs("div",{className:"bg-green-50 p-4 rounded-xl text-center border border-green-100",children:[t.jsxs("div",{className:"text-2xl font-bold text-green-600",children:["GHS ",((e==null?void 0:e.totalAmount)||0).toFixed(2)]}),t.jsx("div",{className:"text-sm text-green-600 font-medium",children:"Total Amount"})]})]})]}),t.jsxs("div",{className:"bg-white rounded-xl shadow-sm p-4",children:[t.jsxs("div",{className:"flex items-center justify-between mb-4",children:[t.jsx("h2",{className:"text-lg font-semibold text-gray-900",children:"Quick Actions"}),t.jsx("button",{onClick:()=>n(!o),className:`p-2 rounded-lg transition-colors ${o?"bg-red-100 text-red-600 hover:bg-red-200":"bg-blue-100 text-blue-600 hover:bg-blue-200"}`,children:o?t.jsx(Se,{size:20}):t.jsx(le,{size:20})})]}),t.jsxs("div",{className:"grid grid-cols-2 gap-3 mb-4",children:[t.jsxs("button",{onClick:()=>n(!0),className:"bg-blue-600 hover:bg-blue-700 text-white p-3 rounded-xl flex items-center justify-center gap-2 transition-colors",children:[t.jsx(M,{size:18}),t.jsx("span",{className:"text-sm font-medium",children:"New Calculation"})]}),t.jsxs("button",{onClick:l,className:"bg-white border border-gray-200 hover:bg-gray-50 text-gray-700 p-3 rounded-xl flex items-center justify-center gap-2 transition-colors",children:[t.jsx(W,{size:18}),t.jsx("span",{className:"text-sm font-medium",children:"Export"})]})]})]}),t.jsxs("div",{className:"bg-white rounded-xl shadow-sm p-4",children:[t.jsx("h2",{className:"text-lg font-semibold text-gray-900 mb-4",children:"Recent Calculations"}),r?t.jsxs("div",{className:"text-gray-500 text-center py-8",children:[t.jsx("div",{className:"animate-spin rounded-full h-8 w-8 border-b-2 border-blue-600 mx-auto"}),t.jsx("p",{className:"mt-2",children:"Loading..."})]}):t.jsxs("div",{className:"space-y-3",children:[a.slice(0,5).map(s=>{var c,i,h,x;return t.jsxs("div",{className:"bg-gray-50 rounded-lg p-4 border border-gray-200",children:[t.jsx("div",{className:"flex items-start justify-between mb-2",children:t.jsxs("div",{className:"flex-1",children:[t.jsxs("h3",{className:"font-semibold text-gray-900",children:["Week ",s.weekNumber]}),t.jsx("p",{className:"text-sm text-gray-600",children:new Date(((i=(c=s.createdAt)==null?void 0:c.toDate)==null?void 0:i.call(c))||s.createdAt).toLocaleDateString()})]})}),t.jsxs("div",{className:"grid grid-cols-2 gap-4 text-sm",children:[t.jsxs("div",{children:[t.jsx("p",{className:"text-gray-500",children:"Total"}),t.jsxs("p",{className:"font-medium text-gray-900",children:["GHS ",(h=s.totalSum)==null?void 0:h.toFixed(2)]})]}),t.jsxs("div",{children:[t.jsx("p",{className:"text-gray-500",children:"Each Teacher"}),t.jsxs("p",{className:"font-medium text-gray-900",children:["GHS ",(x=s.eachTeacher)==null?void 0:x.toFixed(2)]})]})]})]},s.id)}),a.length===0&&t.jsxs("div",{className:"text-gray-500 text-center py-8 bg-gray-50 rounded-lg",children:[t.jsx(M,{size:32,className:"mx-auto mb-2 text-gray-400"}),t.jsx("p",{children:"No calculations found"})]})]})]})]});let Ke={data:""},Ze=e=>typeof window=="object"?((e?e.querySelector("#_goober"):window._goober)||Object.assign((e||document.head).appendChild(document.createElement("style")),{innerHTML:" ",id:"_goober"})).firstChild:e||Ke,Ve=/(?:([\u0080-\uFFFF\w-%@]+) *:? *([^{;]+?);|([^;}{]*?) *{)|(}\s*)/g,Qe=/\/\*[^]*?\*\/|  +/g,oe=/\n+/g,H=(e,a)=>{let r="",o="",n="";for(let l in e){let s=e[l];l[0]=="@"?l[1]=="i"?r=l+" "+s+";":o+=l[1]=="f"?H(s,l):l+"{"+H(s,l[1]=="k"?"":a)+"}":typeof s=="object"?o+=H(s,a?a.replace(/([^,])+/g,c=>l.replace(/([^,]*:\S+\([^)]*\))|([^,])+/g,i=>/&/.test(i)?i.replace(/&/g,c):c?c+" "+i:i)):l):s!=null&&(l=/^--/.test(l)?l:l.replace(/[A-Z]/g,"-$&").toLowerCase(),n+=H.p?H.p(l,s):l+":"+s+";")}return r+(a&&n?a+"{"+n+"}":n)+o},A={},me=e=>{if(typeof e=="object"){let a="";for(let r in e)a+=r+me(e[r]);return a}return e},Xe=(e,a,r,o,n)=>{let l=me(e),s=A[l]||(A[l]=(i=>{let h=0,x=11;for(;h<i.length;)x=101*x+i.charCodeAt(h++)>>>0;return"go"+x})(l));if(!A[s]){let i=l!==e?e:(h=>{let x,f,m=[{}];for(;x=Ve.exec(h.replace(Qe,""));)x[4]?m.shift():x[3]?(f=x[3].replace(oe," ").trim(),m.unshift(m[0][f]=m[0][f]||{})):m[0][x[1]]=x[2].replace(oe," ").trim();return m[0]})(e);A[s]=H(n?{["@keyframes "+s]:i}:i,r?"":"."+s)}let c=r&&A.g?A.g:null;return r&&(A.g=A[s]),((i,h,x,f)=>{f?h.data=h.data.replace(f,i):h.data.indexOf(i)===-1&&(h.data=x?i+h.data:h.data+i)})(A[s],a,o,c),s},Ye=(e,a,r)=>e.reduce((o,n,l)=>{let s=a[l];if(s&&s.call){let c=s(r),i=c&&c.props&&c.props.className||/^go/.test(c)&&c;s=i?"."+i:c&&typeof c=="object"?c.props?"":H(c,""):c===!1?"":c}return o+n+(s??"")},"");function I(e){let a=this||{},r=e.call?e(a.p):e;return Xe(r.unshift?r.raw?Ye(r,[].slice.call(arguments,1),a.p):r.reduce((o,n)=>Object.assign(o,n&&n.call?n(a.p):n),{}):r,Ze(a.target),a.g,a.o,a.k)}let xe,Z,V;I.bind({g:1});let T=I.bind({k:1});function et(e,a,r,o){H.p=a,xe=e,Z=r,V=o}function C(e,a){let r=this||{};return function(){let o=arguments;function n(l,s){let c=Object.assign({},l),i=c.className||n.className;r.p=Object.assign({theme:Z&&Z()},c),r.o=/ *go\d+/.test(i),c.className=I.apply(r,o)+(i?" "+i:"");let h=e;return e[0]&&(h=c.as||e,delete c.as),V&&h[0]&&V(c),xe(h,c)}return n}}var tt=e=>typeof e=="function",Q=(e,a)=>tt(e)?e(a):e,at=(()=>{let e=0;return()=>(++e).toString()})(),rt=(()=>{let e;return()=>{if(e===void 0&&typeof window<"u"){let a=matchMedia("(prefers-reduced-motion: reduce)");e=!a||a.matches}return e}})(),st=20,be="default",pe=(e,a)=>{let{toastLimit:r}=e.settings;switch(a.type){case 0:return{...e,toasts:[a.toast,...e.toasts].slice(0,r)};case 1:return{...e,toasts:e.toasts.map(s=>s.id===a.toast.id?{...s,...a.toast}:s)};case 2:let{toast:o}=a;return pe(e,{type:e.toasts.find(s=>s.id===o.id)?1:0,toast:o});case 3:let{toastId:n}=a;return{...e,toasts:e.toasts.map(s=>s.id===n||n===void 0?{...s,dismissed:!0,visible:!1}:s)};case 4:return a.toastId===void 0?{...e,toasts:[]}:{...e,toasts:e.toasts.filter(s=>s.id!==a.toastId)};case 5:return{...e,pausedAt:a.time};case 6:let l=a.time-(e.pausedAt||0);return{...e,pausedAt:void 0,toasts:e.toasts.map(s=>({...s,pauseDuration:s.pauseDuration+l}))}}},ot=[],lt={toasts:[],pausedAt:void 0,settings:{toastLimit:st}},E={},ge=(e,a=be)=>{E[a]=pe(E[a]||lt,e),ot.forEach(([r,o])=>{r===a&&o(E[a])})},fe=e=>Object.keys(E).forEach(a=>ge(e,a)),nt=e=>Object.keys(E).find(a=>E[a].toasts.some(r=>r.id===e)),re=(e=be)=>a=>{ge(a,e)},ct=(e,a="blank",r)=>({createdAt:Date.now(),visible:!0,dismissed:!1,type:a,ariaProps:{role:"status","aria-live":"polite"},message:e,pauseDuration:0,...r,id:(r==null?void 0:r.id)||at()}),z=e=>(a,r)=>{let o=ct(a,e,r);return re(o.toasterId||nt(o.id))({type:2,toast:o}),o.id},w=(e,a)=>z("blank")(e,a);w.error=z("error");w.success=z("success");w.loading=z("loading");w.custom=z("custom");w.dismiss=(e,a)=>{let r={type:3,toastId:e};a?re(a)(r):fe(r)};w.dismissAll=e=>w.dismiss(void 0,e);w.remove=(e,a)=>{let r={type:4,toastId:e};a?re(a)(r):fe(r)};w.removeAll=e=>w.remove(void 0,e);w.promise=(e,a,r)=>{let o=w.loading(a.loading,{...r,...r==null?void 0:r.loading});return typeof e=="function"&&(e=e()),e.then(n=>{let l=a.success?Q(a.success,n):void 0;return l?w.success(l,{id:o,...r,...r==null?void 0:r.success}):w.dismiss(o),n}).catch(n=>{let l=a.error?Q(a.error,n):void 0;l?w.error(l,{id:o,...r,...r==null?void 0:r.error}):w.dismiss(o)}),e};var it=T`
from {
...
to {
  ...
  animation: ${wt} 0.3s 0.12s cubic-bezier(0.175, 0.885, 0.32, 1.275)
    forwards;
`,Nt=({toast:e})=>{let{icon:a,type:r,iconTheme:o}=e;return a!==void 0?typeof a=="string"?u.createElement(jt,null,a):a:r==="blank"?null:u.createElement(yt,null,u.createElement(xt,{...o}),r!=="loading"&&u.createElement(ft,null,r==="error"?u.createElement(ht,{...o}):u.createElement(gt,{...o})))},vt=e=>`
0% {transform: translate3d(0,${e*-200}%,0) scale(.6); opacity:.5;}
100% {transform: translate3d(0,0,0) scale(1); opacity:1;}
`,St=e=>`
0% {transform: translate3d(0,0,-1px) scale(1); opacity:1;}
100% {transform: translate3d(0,${e*-150}%,-1px) scale(.6); opacity:0;}
`,kt="0%{opacity:0;} 100%{opacity:1;}",At="0%{opacity:1;} 100%{opacity:0;}",$t=C("div")`
  display: flex;
  align-items: center;
  background: #fff;
  color: #363636;
...
`;var j=w;const Ct=({addAllowance:e,checkWeekExists:a})=>{const[r,o]=u.useState({weekNumber:"",numberOfTeachers:"",numberOfJHSTeachers:"",welfareAmount:"",classAmounts:{creche:"",nursery1:"",nursery2:"",kg1:"",kg2:"",basic1:"",basic2:"",basic3:"",basic4:"",basic5:"",basic6:"",basic7General:"",basic7JHS:"",basic8General:"",basic8JHS:"",basic9General:"",basic9JHS:""}}),[n,l]=u.useState(null),s=()=>{const i=Object.fromEntries(Object.entries(r.classAmounts).map(([R,O])=>[R,parseFloat(O)||0])),h=parseInt(r.numberOfTeachers)||0,x=parseInt(r.numberOfJHSTeachers)||0,f=parseFloat(r.welfareAmount)||0;if(!r.weekNumber||h===0){j.error("Week number and number of teachers are required");return}const m=Object.values(i).reduce((R,O)=>R+O,0),g=m-f,d=g*.05,p=g-d,N=p*.05,v=p-N,F=i.basic7JHS+i.basic8JHS+i.basic9JHS,q=h>0?v/h:0,U=x>0?F/x:0;l({weekNumber:parseInt(r.weekNumber),totalSum:m,welfare:f,balanceAfterWelfare:g,office:d,balanceAfterOffice:p,kitchen:N,balanceAfterKitchen:v,eachTeacher:q,jhsClasses:F,eachJHSTeacher:U,amounts:i,numberOfTeachers:h,numberOfJHSTeachers:x})},c=async()=>{if(n)try{if(await a(n.weekNumber)){j.error("Calculation for this week already exists");return}const h={...n,createdAt:new Date};await e(h),j.success("Calculation saved successfully"),o({weekNumber:"",numberOfTeachers:"",numberOfJHSTeachers:"",welfareAmount:"",classAmounts:{creche:"",nursery1:"",nursery2:"",kg1:"",kg2:"",basic1:"",basic2:"",basic3:"",basic4:"",basic5:"",basic6:"",basic7General:"",basic7JHS:"",basic8General:"",basic8JHS:"",basic9General:"",basic9JHS:""}}),l(null)}catch{j.error("Failed to save calculation")}};return t.jsx("div",{className:"space-y-4",children:t.jsxs("div",{className:"bg-white rounded-xl shadow-sm p-4",children:[t.jsx("h2",{className:"text-lg font-semibold text-gray-900 mb-4",children:"New Calculation"}),t.jsxs("div",{className:"space-y-4",children:[t.jsxs("div",{className:"grid grid-cols-1 gap-4",children:[t.jsx("input",{type:"number",placeholder:"Week Number (1-16)",value:r.weekNumber,onChange:i=>o({...r,weekNumber:i.target.value}),className:"p-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"}),t.jsx("input",{type:"number",placeholder:"Number of Teachers",value:r.numberOfTeachers,onChange:i=>o({...r,numberOfTeachers:i.target.value}),className:"p-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"}),t.jsx("input",{type:"number",placeholder:"Number of JHS Teachers",value:r.numberOfJHSTeachers,onChange:i=>o({...r,numberOfJHSTeachers:i.target.value}),className:"p-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"}),t.jsx("input",{type:"number",placeholder:"Welfare Amount",value:r.welfareAmount,onChange:i=>o({...r,welfareAmount:i.target.value}),className:"p-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"})]}),t.jsx("h3",{className:"text-md font-medium text-gray-800",children:"Class Amounts (GHS)"}),t.jsx("div",{className:"grid grid-cols-2 gap-3",children:Object.keys(r.classAmounts).map(i=>t.jsx("input",{type:"number",placeholder:i.replace(/([A-Z])/g," $1").replace(/^./,h=>h.toUpperCase()),value:r.classAmounts[i],onChange:h=>o({...r,classAmounts:{...r.classAmounts,[i]:h.target.value}}),className:"p-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 text-sm"},i))}),t.jsxs("button",{onClick:s,className:"w-full bg-blue-600 hover:bg-blue-700 text-white p-3 rounded-lg flex items-center justify-center gap-2 font-medium transition-colors",children:[t.jsx(M,{size:20}),t.jsx("span",{children:"Calculate"})]})]}),n&&t.jsxs("div",{className:"mt-6 p-4 bg-green-50 rounded-lg border border-green-200",children:[t.jsxs("h3",{className:"text-lg font-semibold text-green-900 mb-4",children:["Week ",n.weekNumber," Results"]}),t.jsxs("div",{className:"space-y-2 text-sm",children:[t.jsxs("div",{className:"flex justify-between",children:[t.jsx("span",{children:"Total Sum:"}),t.jsxs("span",{className:"font-medium",children:["GHS ",n.totalSum.toFixed(2)]})]}),t.jsxs("div",{className:"flex justify-between",children:[t.jsx("span",{children:"Welfare:"}),t.jsxs("span",{className:"font-medium",children:["GHS ",n.welfare.toFixed(2)]})]}),t.jsxs("div",{className:"flex justify-between",children:[t.jsx("span",{children:"Office (5%):"}),t.jsxs("span",{className:"font-medium",children:["GHS ",n.office.toFixed(2)]})]}),t.jsxs("div",{className:"flex justify-between",children:[t.jsx("span",{children:"Kitchen (5%):"}),t.jsxs("span",{className:"font-medium",children:["GHS ",n.kitchen.toFixed(2)]})]}),t.jsxs("div",{className:"flex justify-between border-t pt-2",children:[t.jsx("span",{className:"font-medium",children:"Each Teacher:"}),t.jsxs("span",{className:"font-bold text-green-600",children:["GHS ",n.eachTeacher.toFixed(2)]})]}),t.jsxs("div",{className:"flex justify-between",children:[t.jsx("span",{className:"font-medium",children:"Each JHS Teacher:"}),t.jsxs("span",{className:"font-bold text-blue-600",children:["GHS ",n.eachJHSTeacher.toFixed(2)]})]})]}),t.jsxs("button",{onClick:c,className:"w-full mt-4 bg-green-600 hover:bg-green-700 text-white p-3 rounded-lg flex items-center justify-center gap-2 font-medium transition-colors",children:[t.jsx(le,{size:20}),t.jsx("span",{children:"Save Calculation"})]})]})]})})},Ft=({allowances:e,loading:a})=>{const[r,o]=u.useState(""),n=u.useMemo(()=>{if(!r)return e;const l=r.toLowerCase();return e.filter(s=>s.weekNumber.toString().includes(l)||s.totalSum.toString().includes(l))},[e,r]);return t.jsx("div",{className:"space-y-4",children:t.jsxs("div",{className:"bg-white rounded-xl shadow-sm p-4",children:[t.jsxs("div",{className:"flex items-center justify-between mb-4",children:[t.jsx("h2",{className:"text-lg font-semibold text-gray-900",children:"Calculation History"}),t.jsxs("div",{className:"flex items-center bg-gray-50 border border-gray-200 rounded-lg px-3 py-2 flex-1 ml-4 max-w-xs",children:[t.jsx(ke,{size:16,className:"text-gray-500 mr-2"}),t.jsx("input",{placeholder:"Search by week...",value:r,onChange:l=>o(l.target.value),className:"bg-transparent border-none outline-none w-full text-sm text-gray-900 placeholder-gray-500"})]})]}),a?t.jsxs("div",{className:"text-gray-500 text-center py-8",children:[t.jsx("div",{className:"animate-spin rounded-full h-8 w-8 border-b-2 border-blue-600 mx-auto"}),t.jsx("p",{className:"mt-2",children:"Loading..."})]}):t.jsxs("div",{className:"space-y-3",children:[n.map(l=>{var s,c,i,h,x;return t.jsxs("div",{className:"bg-gray-50 rounded-lg p-4 border border-gray-200",children:[t.jsx("div",{className:"flex items-start justify-between mb-2",children:t.jsxs("div",{className:"flex-1",children:[t.jsxs("h3",{className:"font-semibold text-gray-900",children:["Week ",l.weekNumber]}),t.jsx("p",{className:"text-sm text-gray-600",children:new Date(((c=(s=l.createdAt)==null?void 0:s.toDate)==null?void 0:c.call(s))||l.createdAt).toLocaleDateString()})]})}),t.jsxs("div",{className:"grid grid-cols-3 gap-4 text-sm",children:[t.jsxs("div",{children:[t.jsx("p",{className:"text-gray-500",children:"Total"}),t.jsxs("p",{className:"font-medium text-gray-900",children:["GHS ",(i=l.totalSum)==null?void 0:i.toFixed(2)]})]}),t.jsxs("div",{children:[t.jsx("p",{className:"text-gray-500",children:"Each Teacher"}),t.jsxs("p",{className:"font-medium text-gray-900",children:["GHS ",(h=l.eachTeacher)==null?void 0:h.toFixed(2)]})]}),t.jsxs("div",{children:[t.jsx("p",{className:"text-gray-500",children:"Each JHS"}),t.jsxs("p",{className:"font-medium text-gray-900",children:["GHS ",(x=l.eachJHSTeacher)==null?void 0:x.toFixed(2)]})]})]})]},l.id)}),n.length===0&&t.jsxs("div",{className:"text-gray-500 text-center py-8 bg-gray-50 rounded-lg",children:[t.jsx(Ge,{size:32,className:"mx-auto mb-2 text-gray-400"}),t.jsx("p",{children:"No calculations found"})]})]})]})})},ye=async e=>{e(!0);try{const{records:a}=await te(),{records:r}=await he();let o=`
    ...
    `,f=new Blob([x],{type:"text/html"}),m=URL.createObjectURL(f),g=document.createElement("a");g.href=m,g.download=`date-range-report-${new Date().toISOString().split("T")[0]}.html`,document.body.appendChild(g),g.click(),document.body.removeChild(g),URL.revokeObjectURL(m),j.success("Date range report downloaded successfully!")}catch(o){console.error("Error generating date range report:",o),j.error("Failed to generate date range report")}finally{r(!1)}},Et=async(e,a)=>{if(e){a(!0);try{const r=`
      <html>
        <head>
          <style>
            body { font-family: Arial, sans-serif; margin: 20px; }
